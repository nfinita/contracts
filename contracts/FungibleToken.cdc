...
pub contract interface FungibleToken {
    ...
    pub resource Vault: Provider, Receiver, Balance {
        ...
        pub fun withdraw(amount: UFix64): @Vault {
            pre {
                self.balance >= amount:
                    "Amount withdrawn from the vault must be less than or equal to your current balance."
            }
            post {
                ...
                self.balance == before(self.balance) - amount:
                    "Balance must be the amount of the previous balance minus the withdrawn amount."
            }
        }
